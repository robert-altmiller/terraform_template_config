...
export ISSUE_BRANCH_NAME=issue-775-branch
export ISSUE_BRANCH_NAME_MAIN=issue-775-main-branch
export ISSUE_RESOURCE_NAME=dbx-share2
...
export GITHUB_ISSUE_NUMBER=775
