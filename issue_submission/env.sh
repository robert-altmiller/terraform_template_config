...
export ISSUE_BRANCH_NAME=issue-676-branch
export ISSUE_BRANCH_NAME_MAIN=issue-676-main-branch
export ISSUE_RESOURCE_NAME=my-el
...
export GITHUB_ISSUE_NUMBER=676
