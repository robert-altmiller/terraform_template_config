...
export ISSUE_BRANCH_NAME=issue-682-branch
export ISSUE_BRANCH_NAME_MAIN=issue-682-main-branch
export ISSUE_RESOURCE_NAME=my-sc-2
...
export GITHUB_ISSUE_NUMBER=682
