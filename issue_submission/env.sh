export XLSX_JSON=unity_catalog
export ENVIRONMENT=unity_catalog
export ISSUE_BRANCH_NAME=issue-6885687822-branch
export ISSUE_BRANCH_NAME_MAIN=issue-6885687822-main-branch
...
export GITHUB_ISSUE_NUMBER=6885687822
